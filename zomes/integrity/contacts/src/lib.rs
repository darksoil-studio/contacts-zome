...
mod private_contacts_entry;
pub use private_contacts_entry::*;
...
pub enum EntryTypes {
    ...
    PrivateContactsEntry(PrivateContactsEntry),
}
    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
        FlatOp::StoreEntry(store_entry) => match store_entry {
            OpEntry::CreateEntry { app_entry, action } => match app_entry {
                EntryTypes::PrivateContactsEntry(private_contacts_entry) => {
                    validate_create_private_contacts_entry(
                        EntryCreationAction::Create(action),
                        private_contacts_entry,
                    )
                }
        ...
        FlatOp::RegisterUpdate(update_entry) => match update_entry {
            OpUpdate::Entry { app_entry, action } => match app_entry {
                EntryTypes::PrivateContactsEntry(private_contacts_entry) => {
                    validate_update_private_contacts_entry(action, private_contacts_entry)
                }
                EntryTypes::EncryptedMessage(encrypted_message) => {
        ...
        FlatOp::RegisterDelete(delete_entry) => {
            ...
            match original_app_entry {
                EntryTypes::PrivateContactsEntry(_) => {
                    validate_delete_private_contacts_entry(action)
                }
        ...
        FlatOp::StoreRecord(store_record) => match store_record {
            ...
            OpRecord::UpdateEntry {
                ...
                EntryTypes::PrivateContactsEntry(private_contacts_entry) => {
                    let result = validate_create_private_contacts_entry(
                        EntryCreationAction::Update(action.clone()),
                        private_contacts_entry.clone(),
                    )?;
