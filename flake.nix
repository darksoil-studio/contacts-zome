{
  ...
  outputs = inputs:
    inputs.flake-parts.lib.mkFlake
      ...
      {
        imports = [
          ./zomes/integrity/contacts/zome.nix
          ./zomes/coordinator/contacts/zome.nix
            ...
            packages.scaffold = pkgs.symlinkJoin {
              ...
              postBuild = ''
                wrapProgram $out/bin/scaffold-remote-zome \
                  --add-flags "contacts-zome \
                    --integrity-zome-name contacts_integrity \
                    --coordinator-zome-name contacts \
                    --remote-zome-git-url github:darksoil-studio/contacts-zome \
                    --remote-npm-package-name @darksoil-studio/contacts-zome \
                    --remote-zome-git-branch main-0.4 \
                    --context-element contacts-context \
                    --context-element-import @darksoil-studio/contacts-zome/dist/elements/contacts-context.js" 
              '';
            };
          };
      };
